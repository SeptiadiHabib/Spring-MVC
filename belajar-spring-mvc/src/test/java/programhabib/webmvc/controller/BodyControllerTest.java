...
import programhabib.webmvc.model.HelloRequest;
import programhabib.webmvc.model.HelloResponse;
...
class BodyControllerTest {
    ...
    void bodyHello() throws Exception {
        ...
        mockMvc.perform(
            ...
            assertEquals("Hello Habib", response.getHello());
        });
    }
}