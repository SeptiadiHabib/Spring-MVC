...
public class HelloControllerIntegrationTest {
    ...
    @Test
    void helloHabib() {
        ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://localhost:" + port + "/hello?name=Habib", String.class);
        String response = responseEntity.getBody();

        Assertions.assertNotNull(response);
        Assertions.assertEquals("Hello Habib", response.trim());
    }
}
